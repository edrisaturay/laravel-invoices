![![Banner]](https://banners.beyondco.de/Laravel%20Invoices.png?theme=light&packageManager=composer+require&packageName=edrisaturay%2Flaravel-invoices&pattern=architect&style=style_1&description=PDFs+made+easy&md=1&showWatermark=0&fontSize=100px&images=document-download)

# Laravel Invoices

[![Latest Stable Version](https://poser.pugx.org/edrisaturay/laravel-invoices/v/stable?2)](https://packagist.org/packages/edrisaturay/laravel-invoices)
[![Total Downloads](https://poser.pugx.org/edrisaturay/laravel-invoices/downloads?2)](https://packagist.org/packages/edrisaturay/laravel-invoices)
[![Latest Unstable Version](https://poser.pugx.org/edrisaturay/laravel-invoices/v/unstable)](https://packagist.org/packages/edrisaturay/laravel-invoices)
[![License](https://poser.pugx.org/edrisaturay/laravel-invoices/license)](https://packagist.org/packages/edrisaturay/laravel-invoices)

[![version 2](https://img.shields.io/badge/v4%20maintenance-yes-green?style=flat)](https://packagist.org/packages/edrisaturay/laravel-invoices)
[![version 1](https://img.shields.io/badge/v3%20maintenance-no-red?style=flat)](https://packagist.org/packages/edrisaturay/laravel-invoices)
...
[ico-version]: https://img.shields.io/packagist/v/edrisaturay/laravel-invoices.svg?style=flat-square
[ico-downloads]: https://img.shields.io/packagist/dt/edrisaturay/laravel-invoices.svg?style=flat-square
[ico-travis]: https://img.shields.io/travis/edrisaturay/laravel-invoices/master.svg?style=flat-square
[ico-styleci]: https://styleci.io/repos/12345678/shield

[link-packagist]: https://packagist.org/packages/edrisaturay/laravel-invoices
[link-downloads]: https://packagist.org/packages/edrisaturay/laravel-invoices
[link-travis]: https://travis-ci.org/edrisaturay/laravel-invoices
